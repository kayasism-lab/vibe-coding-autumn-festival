...
/**
 * 검색 결과에 표시되는 대표 소개 문구.
 * 네이버는 80자가 넘으면 뒤가 잘리므로 80자 이내로 맞췄다
 * (네이버 웹마스터도구 '사이트 간단 체크' 권장사항)
 */
export const SITE_DESCRIPTION =
  '직연협이 여는 2026 가을연극축제 「직장인들의 이중생활」. 연극과 시민참여 낭독극·단막극, 9/19~11/29 서울, 전석 무료.'

/**
 * 긴 소개 문구. 글자 수 제한이 없는 구조화 데이터(JSON-LD)에 쓴다.
 * 검색엔진이 사이트 성격을 파악하는 데는 자세할수록 좋기 때문에 따로 둔다
 */
