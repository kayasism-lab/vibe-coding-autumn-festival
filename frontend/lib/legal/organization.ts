// 개인정보처리방침·이용약관 등 법적 고지 문서가 공통으로 쓰는 운영 주체 정보.
// 여러 문서에 흩어져 있으면 연락처가 바뀔 때 한 곳을 놓치기 쉬워 여기로 모았다.
// 이메일·전화는 푸터(components/layout/footer.tsx)에 표시되는 값과 일치해야 한다.
...
export const PRIVACY_OFFICER_NAME = '문성환'
export const PRIVACY_OFFICER_TITLE = '회장'
